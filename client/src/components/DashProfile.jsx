  ...
  return (
    <div className='max-w-lg mx-auto p-3 w-full'>
        ...
        <form className='flex flex-col gap-4'>
            ...
            />)}
            <img src={imageFileUrl || currentUser.profilePicture} alt="user" className={`rounded-full w-full h-full object-cover border-8 border-[lightgray] ${imageFileUploading && imageFileUploading < 100 && 'opacity-60'}`}/>
            </div>
