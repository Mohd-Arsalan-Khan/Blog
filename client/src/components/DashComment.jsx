...
import {FaCheck, FaSadCry, FaTimes} from 'react-icons/fa'
...
function DashComment() {
  ...
  const handleShowMore = async () =>{
    ...
    try {
      ...
      if (res.ok) {
        setComments((prev) => [...prev, ...data.commetns])
       ...
       <Modal show={showModal} onClose={() => setShowModal(false)} popup size='md'>
        ...
        <Modal.Body>
            <div className='text-center'>
                ...
                <h3 className='mb-5 text-lg text-gray-500 dark:text-gray-400'>Are you sure you want to delete this comments</h3>
