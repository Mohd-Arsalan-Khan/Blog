  ...
  return (
    <div>
      <div className="flex flex-col gap-6 p-28 px-3 max-w-6xl mx-auto">
        ...
        <p className='text-gray-500 text-xs sm:text-sm'>Here you'll find a varity of articles and tutorials on topics such as web development, software engineering, and programming languages.</p>
